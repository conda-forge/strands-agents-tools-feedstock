About strands-agents-tools-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/strands-agents-tools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/strands-agents-tools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add strands-agents-tools
# for installing globally
pixi global install strands-agents-tools
```
...
It is possible to list all of the versions of `strands-agents-tools` available on your platform:
...
```
pixi search strands-agents-tools --channel conda-forge
```
